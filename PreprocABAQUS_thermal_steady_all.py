...
s2 = a.instances['Part-2-1'].edges
side1Edges2 = s2.getSequenceFromMask(mask=('[#1002044 ]', ), )
region=a.Surface(side1Edges=side1Edges1+side1Edges2, name='Surf-Inner')
...
mdb.models['Model-1'].SurfaceToSurfaceContactStd(name='Int-Conduction-1', 
...
region2=regionToolset.Region(side1Edges=side1Edges1)
mdb.models['Model-1'].SurfaceToSurfaceContactStd(name='Int-Conduction-2', 
    createStepName='Initial', master=region1, slave=region2, sliding=FINITE, 
    thickness=ON, interactionProperty='IntProp-Conduction', adjustMethod=NONE, 
    initialClearance=OMIT, datumAxis=None, clearanceRegion=None)

...
#        print experiment.half_life_cycle
        x = experiment.obtainNthCycle('axial_strain',experiment.half_life_cycle)
        y = experiment.obtainNthCycle('shear_strain',experiment.half_life_cycle)
        plot_data.addLine(x*100,
                          y*100,
                          xlabel=xlabel,
                          ylabel=ylabel,
...
# show legend
#==============================================================================
    lg = plt.legend(title=r'$\Delta\varepsilon_{eq}/2$',loc=2)
    title = lg.get_title()
...
figure_name='plot_exp_half_life_cycle_NPRIP_strain'

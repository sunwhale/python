...
def create_plot_data_exp_pv_NPRIP_torsional(figure_path=None,figure_name=None):
#==============================================================================
# x,y label
#==============================================================================
...
#    for name in experiment_type_dict['TC-OP']:
    for name in ['7036','7034','7046','7028','7037']:
        print name
        ...
        cycle,peak,valley = experiment.obtainPeakValley('shear_stress')
...
def plot_exp_pv_NPRIP_torsional(figure_path=None,figure_name=None,save_types=[]):
#==============================================================================
# title
#==============================================================================
    title=''
...
# annotate
#==============================================================================
    plt.text(10,400,r'Peak stress',fontsize=14)
    plt.text(10,80,r'Mean stress',fontsize=14)
    plt.text(10,-450,r'Valley stress',fontsize=14)
#==============================================================================
# save figures
#==============================================================================
...
figure_name='plot_exp_pv_NPRIP_torsional'
create_plot_data_exp_pv_NPRIP_torsional(figure_path,figure_name)
plot_exp_pv_NPRIP_torsional(figure_path,figure_name,save_types=['.pdf'])

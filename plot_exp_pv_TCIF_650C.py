...
def create_plot_data_exp_pv_TCIF_650C(figure_path=None,figure_name=None):
#==============================================================================
# x,y label
#==============================================================================
...
#==============================================================================
    ...
    for name in experiment_type_dict['TC-IF']:
        ...
        plot_data.addLine(cycle,
                          ...
                          xlabel=xlabel,
                          ylabel=ylabel,
                          linelabel=str(axial_strain) + ' ' + name,
                          linewidth=2,
                          linestyle='-',
                          marker=None,
                          markersize=12,
...
def plot_exp_pv_TCIF_650C(figure_path=None,figure_name=None,save_types=[]):
#==============================================================================
# title
#==============================================================================
    title=''
...
figure_name='plot_exp_pv_TCIF_650C'
#create_plot_data_exp_pv_TCIF_650C(figure_path,figure_name)
plot_exp_pv_TCIF_650C(figure_path,figure_name,save_types=['.pdf'])

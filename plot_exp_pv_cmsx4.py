...
def create_plot_data_exp_pv_TCOP(figure_path=None,figure_name=None):
#==============================================================================
# x,y label
#==============================================================================
...
#    color_list = ['blue','red','black','green']
    ...
    for name in experiment_type_dict['TMF-OP']:
        print name
        ...
        plot_data.addLine(cycle,
                          ...
                          xlabel=xlabel,
                          ylabel=ylabel,
                          linelabel='No.' + name + ' ' + get_experiment_type(name,experiment_type_dict) + ' +-' + str(axial_strain) + '%',
                          linewidth=2,
                          linestyle='',
...
def plot_exp_pv_TCOP(figure_path=None,figure_name=None,save_types=[]):
#==============================================================================
# title
#==============================================================================
    title=''

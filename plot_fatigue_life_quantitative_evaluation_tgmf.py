...
fatigue_model_list = ['BM','FS','SWT','Zamrik','Liu1','Liu2','Study2']
...
fatigue_model_list = ['BM','FS','SWT','Zamrik','Liu I','Liu II','Present']
#==============================================================================
# annotate
#==============================================================================
...
n = [0.4,1.4,2.4,3.4,4.4,5.4,6.5]
plt.xticks(n, fatigue_model_list)

figure_path = ArticleFigureDirectory
figure_name = 'plot_fatigue_life_quantitative_evaluation_tgmf_TRMS'
#figure_name = 'plot_fatigue_life_quantitative_evaluation_tgmf_TN'

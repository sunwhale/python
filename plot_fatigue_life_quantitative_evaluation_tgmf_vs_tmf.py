...
fatigue_model_list = ['Study','Study2']
...
fatigue_model_list = ['TMF','TGMF']
#==============================================================================
# annotate
#==============================================================================
plt.text(-0.3,1.3,r'conservative',fontsize=20,color='red')
plt.text(-0.3,0.7,r'non-conservative',fontsize=20,color='red')
...
#figure_name = 'plot_fatigue_life_quantitative_evaluation_tgmf_vs_tmf_TRMS'
figure_name = 'plot_fatigue_life_quantitative_evaluation_tgmf_vs_tmf_TN'
saveFigure(figure_path,figure_name,save_types=['.svg'])

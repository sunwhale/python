...
def plot_schematic_thermal_strain_IP(figure_path=None,figure_name=None,save_types=[]):
#==============================================================================
# title
#==============================================================================
    title=''
...
#==============================================================================
    ...
    plt.plot(x1,y1,label='Mechanical Strain')
    x2 = x1
    y2 = np.array([0,0.4,0,-0.4,0])
    plt.plot(x2,y2,label='Thermal Strain',ls='--')
    x3 = x1
    y3 = y1+y2
    plt.plot(x3,y3,label='Total Strain',ls='-.')
#==============================================================================
...
figure_name='plot_schematic_thermal_strain_IP'
plot_schematic_thermal_strain_IP(figure_path,figure_name,save_types=['.pdf'])

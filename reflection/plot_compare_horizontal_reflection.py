...
#    begin_time = '11:16:58'
    ...
    txt=SimulationDirectory + "HORIZONTALLINE.txt"
    list1 = open(txt,"r").readlines()	
    list2 = [i.strip() for i in list1]
    list3 = [j.split(',') for j in list2]
    x_coordinate = [ float(k[1])  for k in list3 ]
    x_coordinate_shift = [ k + 0.0035  for k in x_coordinate ]
    temp_sim = [ float(k[4])  for k in list3 ]
    
    txt=SimulationDirectory + "HORIZONTALLINE_400W_200s_0.80.txt"
    list1 = open(txt,"r").readlines()	
    list2 = [i.strip() for i in list1]
    list3 = [j.split(',') for j in list2]
    x_coordinate = [ float(k[1])  for k in list3 ]
    ...
    txt=SimulationDirectory + "HORIZONTALLINE_400W_200s_0.90.txt"
    list1 = open(txt,"r").readlines()	
    list2 = [i.strip() for i in list1]
    list3 = [j.split(',') for j in list2]
    x_coordinate = [ float(k[1])  for k in list3 ]
    ...
    txt = SimulationDirectory + "HORIZONTALLINE_400W_200s_1.00.txt"
    list1 = open(txt,"r").readlines()	
    list2 = [i.strip() for i in list1]
    list3 = [j.split(',') for j in list2]
...
#    txt = ExperimentDirectory + "ExperimentalData\\7\\2013_08_21_B11h16m58s_E11h18m28s_800W_NI9213.txt"
    ...
    i = 0
    plot_data.addLine(np.array(x_coordinate_shift)*1000,
    ...
    plot_data.addLine(np.array(node_x[1:10])*1000,
                      np.array(temp_exp[1:10])+273,
                      xlabel=xlabel,
                      ylabel=ylabel,
                      linelabel='Exp.',
                      linewidth=2,
...
#==============================================================================
    ...
    plt.plot([3.8,3.8],[0,1000],lw=1.5,ls='--',color='black')
#==============================================================================
# save figures
#==============================================================================
